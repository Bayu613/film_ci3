                                                ...
                                                <form action="<?= base_url('admin/konten/simpan') ?>" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-content" style="background:#222A42;">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col mb-6">
                                                                    <label style="color: white; margin-top:10px;" for="nameWithTitle" class="form-label">Judul</label>
                                                                    <input type="text" id="nameWithTitle" class="form-control" placeholder="Masukkan Nama" name="judul" required>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col mb-6">
                                                                    <label style="color: white; margin-top:10px;" for="nameWithTitle" class="form-label">Kategori</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col mb-6">
                                                                    <label style="color: white; margin-top:10px;" for="nameWithTitle" class="form-label">Keterangan</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col mb-6">
                                                                    <label style="color: white; margin-top:10px;" for="nameWithTitle" class="form-label">Link Nonton</label>
                                                                    <input type="text" id="nameWithTitle" class="form-control" placeholder="Link Nonton" name="link_nonton" >
                                                                </div>
                                                            </div>

                                                            <div class="row">
                                                                <div class="col mb-6">
                                                                    <label style="color: white; margin-top:10px;" for="nameWithTitle" class="form-label">Link Download</label>
                                                                    <input type="text" id="nameWithTitle" class="form-control" placeholder="Link Download" name="link_download" >
                                                                </div>
                                                            </div>

                                                            <div class="row">
                                                                <div class="col mb-6">
                                                                    <label style="color: white; margin-top:10px;" for="nameWithTitle" class="form-label">Foto</label>
                                                                    ...
                                                                    <div class="modal-content" style="background:#222A42;">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col mb-6">
                                                                                    <label style="color: white; margin-top:10px;" for="nameWithTitle" class="form-label">Foto</label>
                                                                                    <input type="file" id="nameWithTitle" class="form-control" placeholder="Masukkan Nama" value="<?=base_url('upload/konten/' . $aa['foto'])?>" name="foto" 
                                                                                        accept="image/png, image/gif, image/jpeg">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col mb-6">
                                                                                    <label style="color: white; margin-top:10px;" for="nameWithTitle" class="form-label">Link Nonton</label>
                                                                                    <input type="text" id="nameWithTitle" class="form-control" placeholder="Masukkan Link Nonton" name="link_nonton" value="<?= $aa['link_nonton'] ?>" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col mb-6">
                                                                                    <label style="color: white; margin-top:10px;" for="nameWithTitle" class="form-label">Link Download</label>
                                                                                    <input type="text" id="nameWithTitle" class="form-control" placeholder="Masukkan Link Download" name="link_download" value="<?= $aa['link_download'] ?>">
                                                                                </div>
                                                                            </div>
